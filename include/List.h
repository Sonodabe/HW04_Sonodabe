...
public:
    ...
    void insertAll(Entry_Sonodabe* entries, int len);
    //Inserts and checks a whole arrau of entries to a list
    void insertAndCheckAll(Entry_Sonodabe* entries, int len);
    //Inserts one node into the correct part of a list
    void insert(Entry_Sonodabe* toInsert);
    //Inserts and check originality of an entry to the correct part of the list
    void insertAndCheck(Entry_Sonodabe* toInsert);
    //Number of entries
    int length;
    ...
    Entry_Sonodabe* remove(Node* toBeRemoved);
